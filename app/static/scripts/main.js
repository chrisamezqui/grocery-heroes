...
function initConfirmationWindow(event) {
  let contentString = '<div style="color:black" id="helperNotification">'+
                      ...
                      ' to confirm.</p><button style="position: absolute; left: 3; down: 3 id="undoButton">Undo</button>' +
                      '<button style="position: absolute; right: 3; down: 3" id="confirmButton">Confirm</button></div>';
